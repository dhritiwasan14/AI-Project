...
LOAD = True
BESTCSV = "/content/gdrive/My Drive/AI_Project/MODEL/TillEp_5800_data.csv"
BEST = "/content/gdrive/My Drive/AI_Project/CSV/pong_5800.pth.tar"
PLAY = False
        ...
        for episode in range(MAX_EPISODES):
            ...
            for steps in range(MAX_STEPS):
                ...
                if done or steps == MAX_STEPS - 1:
                    ...
                    Qval = Qval.item() #Qval = Qval.detach().numpy()[0, 0]
            ...
            if ((episode+1 + EXTRA) % 200 == 0):  # save every X steps
